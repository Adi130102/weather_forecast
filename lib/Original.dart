...
class _OneState extends State<One> {
  ...
  Future<void> WeathereAditya() async {
    if (lat != null) {
      ...
      myTemperature =
          "Temperature : ${w.temperature?.celsius?.toStringAsPrecision(4)}° C";
      ...
      print("Sunrise : ${DateFormat("dd-MM-yyyy hh:mm:ss a").format(w.sunrise!)}");
      
      // sunSet=w.sunset.toString();
      sunSet=DateFormat("dd-MM-yyyy hh:mm:ss a").format(w.sunset!);
      print("Sunset : ${DateFormat('dd-MM-yyyy hh:mm:ss a').format(w.sunset!)}");
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text("${myTemperature}, ${myAtmosphere}"),
                SizedBox(
                  height: 30.0,
                ),
                Text("DateTime : ${currentDate}   ${currentTime}"),
                SizedBox(
                  height: 30.0,
                ),
                ...
                Text("SunSet : ${sunSet}, ${o1}"),
                SizedBox(
                  height: 30.0,
                ),
                Image.network("https://openweathermap.org/img/wn/${myIcon}@2x.png"),
                SizedBox(
                  height: 30.0,
                ),
